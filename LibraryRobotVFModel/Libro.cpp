...
Libro::Libro(int idLibro, String^ titulo, String^ categoria, String^ estado, int edicion, String^ reseña, String^ etiqueta, String^ autorlibro, String^ disponibilibad, Biblioteca^ objBilioteca, SolicitudPrestamo^ objSolicitudPrestamo, List<Mantenimiento^>^ listaMantenimiento){
	...
	this->disponibilibad = disponibilibad;
	this->objBilioteca = objBilioteca;
...
void Biblioteca::setIdLibro(int idLibro) {
	this->idLibro = idLibro;
}
